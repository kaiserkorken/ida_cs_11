...
Since the positions of the different sites are given in longitude and latitude, the distance between two points can not be calculated with the cartesian distance in cartesian coordinates. For this reason the 

```{r}

# calculate shortest distances between points A and B given by longitude and latitude in km
calc_distance_in_km(lonA, latA, lonB, latB)
```
